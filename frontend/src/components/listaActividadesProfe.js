...
const ListaActividadesProfe = ({ grupo, todosFalse, sO, observationIDList, agregarActividad, setPlanActual, idActivity, editarActividad, setActividadActual, setEditarEstado, setEstadoAEditar}) => {
